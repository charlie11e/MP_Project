...
# IMPORT DATASET
Whole_Day = pd.read_excel("Project/MPInfo.xlsx")
...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["Two vs. Three Scanners", "Alone vs. Teams", "DPH and JPH", "Individual Lane and Side Performance", "Total Lane Diverts"])
